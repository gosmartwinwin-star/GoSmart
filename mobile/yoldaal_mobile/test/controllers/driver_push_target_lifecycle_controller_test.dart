...
import 'package:yoldaal_mobile/controllers/driver_push_target_lifecycle_controller.dart';
...
void main() {
  ...
  test('registration failure is fail-soft and later change continues', () async {
    final fixture = _fixture();
    addTearDown(fixture.dispose);
...
_Fixture _fixture() {
  final source = _InstallationIdSource(
    currentId: _initialFid,
  );
...
class _Fixture {
  ...
  final DriverPushTargetLifecycleController lifecycle;
...
class _AuthSession implements DriverPushTargetAuthSession {
  @override
  Future<void> requireAuthenticatedUser() async {}
}

class _InstallationIdSource
...
class _RecordingInvoker
  ...
  Future<Object?> call(
    ...
    return {
      'updatedAtMillis': payloads.length,
    };
  }
}
